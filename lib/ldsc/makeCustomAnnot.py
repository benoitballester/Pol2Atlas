...
clusterPath = parameters.tempDir + "liftedClusters/"
...
for ch in range(1,23):
    snps = pandas.read_csv(parameters.dataPath + f"ldsc/1000G_EUR_Phase3_plink/1000G.EUR.QC.{ch}.bim", sep="\t", header=None)
    ...
    for i, f in enumerate(files):
        if hasIntersect[i] > 100:   # Remove groups with < 100 SNPs
            ...
            try:
                ...
                pass
    snpAnnotFmt.to_csv(parameters.tempDir + f"ld.{ch}.annot.gz", index=False, sep=" ")
# %%
