...
try:
    ...
    pass
try:
    os.mkdir(paths.outputDir + "rnaseq/profiles/gtex/")
except:
    pass
directory = "/shared/projects/pol2_chipseq/rnaseq_counts_10bp/gtex_10bp/"
...
np.save(paths.tempDir + "pooled_GTEX_10bp.npy", readsPerPol2Bin)
# %%
readsPerPol2Bin = np.load(paths.tempDir + "pooled_GTEX_10bp.npy")
# %%
...
plt.tight_layout()
plt.savefig(paths.outputDir + "rnaseq/profiles/gtex/profile_1kb_heatmap.pdf", bbox_inches="tight")
plt.show()
# %%
plt.figure(dpi=300)
...
plt.savefig(paths.outputDir + "rnaseq/profiles/gtex/profile_1kb.pdf", bbox_inches="tight")
