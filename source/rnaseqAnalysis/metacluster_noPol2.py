...
fig3.write_image(paths.outputDir + "rnaseq/metacluster_umap_noPol2_lines.pdf")
fig3.write_html(paths.outputDir + "rnaseq/metacluster_umap_noPol2_lines.pdf" + ".html")
# %%
# Heatmap
metric='yule'
