...
intersectTab = pd.read_csv(paths.outputDir + "intersectIntergPol2.tsv", sep="\t")
intersectTab.index = intersectTab["Name"]
progBed = pr.read_bed(paths.outputDir + "rnaseq/gtex_rnaseq/DE/bed_Heart").as_df()
intersectTab = intersectTab.loc[progBed["Name"]]
try:
    os.mkdir(paths.outputDir + "intersections_databases/")
except:
...
plt.ylabel("CCRE Category")
plt.xlabel("Fraction of Pol II consensuses")
plt.savefig(paths.outputDir + "intersections_databases/gtex_heart_encode_ccres.pdf", bbox_inches="tight")
plt.show()
plt.close()
...
plt.ylabel("Category")
plt.xlabel("Fraction of Pol II consensuses")
plt.savefig(paths.outputDir + "intersections_databases/gtex_heart_prop_all_db.pdf", bbox_inches="tight")
plt.show()
plt.close()
