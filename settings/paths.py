...
tempDir = "/scratch/pdelangen/projet_these/tempPol2/"       # Temporary files / unimportant
...
polIIannotationPalette = "/scratch/pdelangen/projet_these/data_clean/annotation_palette.tsv"
